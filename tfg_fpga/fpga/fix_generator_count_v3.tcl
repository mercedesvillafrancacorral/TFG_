...
puts "Generic antes (danado por un intento anterior): [get_property generic [get_filesets sources_1]]"

# Restaura la lista COMPLETA original de generics (capturada antes de que un
# intento anterior la reemplazara por error con un solo valor), con
# PORT_GEN_TRAFFIC_COMMON_COUNT cambiado de 3 a 10.
...
puts "Generic despues (restaurado): [get_property generic [get_filesets sources_1]]"
